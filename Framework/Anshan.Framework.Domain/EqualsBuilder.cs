...
namespace Anshan.Framework.Domain
{
    ...
    ///     <see href="http://weblogs.asp.net/arturtrosin/archive/2009/05/08/apache-hash-code-and-equals-builders.aspx">Artur Trosin</see>.
    ...
    public class EqualsBuilder
    {
            ...
            bool useTransients)
        {
             ...
             */
            var fields = clazz.GetFields(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.DeclaredOnly);
