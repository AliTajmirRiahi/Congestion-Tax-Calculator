...
#endregion The Apache Software License

using System;
using System.Reflection;

namespace Anshan.Framework.Domain.EqualityHelpers
{
    /// <summary>
    ...
    public class HashCodeBuilder
    {
        ...
        {
            if (initialNonZeroOddNumber == 0) throw new ArgumentException("HashCodeBuilder requires a non zero initial value");
            if (initialNonZeroOddNumber % 2 == 0) throw new ArgumentException("HashCodeBuilder requires an odd initial value");
            if (multiplierNonZeroOddNumber == 0) throw new ArgumentException("HashCodeBuilder requires a non zero multiplier");
            if (multiplierNonZeroOddNumber % 2 == 0) throw new ArgumentException("HashCodeBuilder requires an odd multiplier");
     ...
     */
        ...
        public HashCodeBuilder Append(object[] array)
        {
            if (array == null)
                ...
                for (var i = 0; i < array.Length; i++) Append(array[i]);
            return this;
        }
